...
@Component({
  selector: 'app-plantinfo-dialog',
  templateUrl: './plantinfo-dialog.component.html',
  styleUrls: ['./plantinfo-dialog.component.css']
})
export class PlantInfoComponent implements OnInit {
  ...
  selectedPlantInfo?: any;

  onSelect(hero: any): void {
    this.selectedPlantInfo = hero;
  }
  ...
  getPlantInfo(){
    const options = {
        method: 'GET',
        headers: {
            'X-RapidAPI-Key': 'd01ffc1b0amshe0272c11f271ed9p1e8642jsn3c490418a6d9',
    ...
    .then(data=>{this.setPlantInfo(data);})
	.catch(err => console.error(err));
  }

  setPlantInfo(data){
    this.PlantInfos = data;
  }

  initializePlantInfo(){
    this.PlantInfos = JSON.parse(`[
        {
          "id": 0,
