...
export class DefaultService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public sensorByHardwareIdHardwareIdGet(hardwareId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Sensor>;
    public sensorByHardwareIdHardwareIdGet(hardwareId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Sensor>>;
    public sensorByHardwareIdHardwareIdGet(hardwareId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Sensor>>;
    public sensorByHardwareIdHardwareIdGet(hardwareId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (hardwareId === null || hardwareId === undefined) {
            throw new Error('Required parameter hardwareId was null or undefined when calling sensorByHardwareIdHardwareIdGet.');
        }
        ...
        let localVarPath = `/sensor/by-hardware-id/${this.configuration.encodeParam({name: "hardwareId", value: hardwareId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}`;
